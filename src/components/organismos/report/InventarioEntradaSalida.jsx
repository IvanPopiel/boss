...
function InventarioEntradaSalida() {
  const [stateListaproductos, setstateListaProductos] = useState(false);
  const { reportInventarioEntradaSalida, buscarProductos, buscador, setBuscador ,selectProductos,productoItemSelect} =
    useProductosStore();
          ...
          <Page size="A4" orientation="landscape">
            <View style={styles.page}>
              <View style={styles.section}>
                ...
                >
                   Inventario - entrada y salida por producto
                </Text>
...
`;
export default InventarioEntradaSalida;
